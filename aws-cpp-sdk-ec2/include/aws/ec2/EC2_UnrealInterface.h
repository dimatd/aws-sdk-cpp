...
namespace UE
{
	...
	AWS_EC2_API bool CreateInstance  (const char* InstanceName, const char* AmiID, Aws::EC2::Model::InstanceType InstanceType, const char* Region, char* OutputMsg, size_t OutputMsgSize);
